...
def process(input_data, phase_setting, input_val):
...
with open("7input.txt") as fp:
    ...
    phase_setting_combos = list(itertools.permutations(phase_settings,5))
    print(phase_setting_combos)
    max_output = 0
    for combo in phase_setting_combos:
        input_val = 0
        for phase_setting in combo:
            print(phase_setting)
            output = process(input_data, phase_setting, input_val)
            input_val = output
